...
interface IContextualBindingManager
{
  ...
  containsDependent(key: symbol,
                    dependentKey: symbol): boolean

  getDependent(key: symbol,
               dependentKey: symbol): (IBindingEntry |
                                       null)

  setDependent(key: symbol,
               dependentKey: symbol,
               entry: IBindingEntry): void

  unsetDependent(key: symbol,
                 dependentKey: symbol): void
}
