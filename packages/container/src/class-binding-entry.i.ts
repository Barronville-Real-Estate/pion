...
interface IClassBindingEntry<ClassTypeT extends ClassSuperType>
  extends IBindingEntry
{
  getClass(): ClassType<ClassTypeT>
}

export {
  IClassBindingEntry as default,

  ClassSuperType as IClassBindingEntryClassSuperType,
  ClassType as IClassBindingEntryClassType
}
