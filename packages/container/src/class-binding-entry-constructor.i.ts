...
interface IClassBindingEntryConstructor
{
  new<ClassTypeT extends ClassSuperType>(class_: ClassType<ClassTypeT>): IClassBindingEntry<ClassTypeT>
}

export default IClassBindingEntryConstructor
