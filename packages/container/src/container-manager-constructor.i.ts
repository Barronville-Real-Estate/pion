...
interface IContainerManagerConstructor
{
  new(classMappings: IClassMappingManager,
      ...
      valueBindings: IValueBindingManager): IContainerManager
}

export default IContainerManagerConstructor
